...
dataDir     = '/Users/wbr/walter/fmri/hcp_7t/102816_proc';
scriptdir   = '/Users/wbr/walter/fmri/sms_scan_analyses/wbr_memolab_fmri_qa_master'; % fileparts(mfilename('fullpath'));
QAdir       = 'QA';
...
for i = 1:length(subjects)
    ...
    % get mean func dumb way 
%     b.meanfunc = spm_select('FPListRec','/Users/wbr/walter/fmri/hcp_7t/102816_proc/T1w/Results/tfMRI_MOVIE1_7T_AP', 'tfMRI_MOVIE1_7T_AP_sebased_reference.nii');
    %
