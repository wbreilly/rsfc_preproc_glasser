...
scriptdir   = '/Users/wbr/walter/fmri/rsfc_preproc_glasser/rsfc_qa_wbr'; % fileparts(mfilename('fullpath'));
QAdir       = 'QA';
...
% nworkers = min(length(subjects),my_cluster.NumWorkers);
...
%     run_status(i).subject = subjects(i);
