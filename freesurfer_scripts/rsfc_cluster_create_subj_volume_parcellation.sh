...
# don't be a moron and save your bash script in a different directory than where your data are
# sh rsfc_create_subj_volume_parcellation.sh -L sub_array.txt -a HCP-MMP1  -d MMP1_native -m YES -f 1 -l 4
